...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "artists" (
  	...
  	"sound_cloud_username" varchar NOT NULL,
  	"sound_cloud_track_id" numeric NOT NULL,
  	"instagram_username" varchar,
  	"resident_advisor_username" varchar,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  CREATE TABLE "events" (
  	...
  	"location_address_country" varchar NOT NULL,
  	"description" varchar NOT NULL,
  	"price" numeric NOT NULL,
  	"before_midnight_price" numeric NOT NULL,
  	"flyer_front_id" integer NOT NULL,
  	"flyer_back_id" integer,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  ALTER TABLE "artists" ADD CONSTRAINT "artists_profile_picture_id_media_id_fk" FOREIGN KEY ("profile_picture_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "events" ADD CONSTRAINT "events_flyer_front_id_media_id_fk" FOREIGN KEY ("flyer_front_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "events" ADD CONSTRAINT "events_flyer_back_id_media_id_fk" FOREIGN KEY ("flyer_back_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "artists_profile_picture_idx" ON "artists" USING btree ("profile_picture_id");
  ...
  CREATE INDEX "events_flyer_flyer_front_idx" ON "events" USING btree ("flyer_front_id");
  CREATE INDEX "events_flyer_flyer_back_idx" ON "events" USING btree ("flyer_back_id");
